...
\hypersetup{
	pdftitle=Sequentially continuous maps on topological groups,
...
{\LARGE\bfseries Sequentially Continuous Maps on Topological Groups}
...
Supervisor of the master thesis: & prof. RNDr. Miroslav Hušek, DrSc. \\
\noalign{\vspace{2mm}}
...
Název práce:
Sequentially Continuous Maps on Topological Groups
% přesně dle zadání
